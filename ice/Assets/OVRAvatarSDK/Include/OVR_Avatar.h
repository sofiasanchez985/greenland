...
typedef struct ovrAvatarSkinnedMeshPose_ {
    int jointCount; ///< Number of joints in the joint hierarchy
...
typedef enum ovrAvatarTextureFormat_ {
	ovrAvatarTextureFormat_RGB24, ///< RGB 24bit uncompressed texture
	ovrAvatarTextureFormat_DXT1,  ///< DXT1 compressed texture
	ovrAvatarTextureFormat_DXT5,  ///< DXT5 compressed texture
